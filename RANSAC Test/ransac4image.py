...
#导入两张图片
imgname_01 = 'E:/Git Projects/Urban-Real-road-Eye-Registration-for-ET-and-Insta360/output/ET_video_frame/frame_0300.jpg'
imgname_02 = 'E:/Git Projects/Urban-Real-road-Eye-Registration-for-ET-and-Insta360/output/Insta_video_frame/frame_0300.jpg'
# imgname_02 = './data/P14-R3-insta360-01.jpg'
...
if len(good) > min_match_count:
    ...
    #返回值中 M 为单应性矩阵。
    M, mask = cv2.findHomography(src_pts, dst_pts, cv2.RANSAC, ransacReprojThreshold, MaxIters=5000)
    #print(mask)
    print(mask.shape)
    #将多维数组转换为一维数组
...
plt.savefig('E:/Git Projects/Urban-Real-road-Eye-Registration-for-ET-and-Insta360/output/ET_Insta_Registra/by_RANASC_0300.png')
